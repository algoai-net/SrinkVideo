...
2. **Il video diviso** — in parti della dimensione indicata, senza ricodifica
...
- Il video è diviso con lo stream copy: i tagli avvengono sui keyframe, quindi le
  parti possono differire leggermente dalla dimensione richiesta (margine del 10%).
